...
import BitbondIframe from "./BitbondIframe";

function PropertyCard({ data, walletAddress }) {
  const [showInvestorModal, setShowInvestorModal] = useState(false);
  const [displayBitbondIframe, setDisplayBitbondIframe] = useState(false);
  ...
  return (
    <div className={classes.propertyCard}>
      ...
      <div className={classes.detailsContainer}>
        <div className={classes.propertyDetailsBelowImage}>
        ...
        <div className={classes.buyPropertyButton}>
          ...
          {displayBitbondIframe && <BitbondIframe propertyData={data} />}
          {showInvestorModal && (
